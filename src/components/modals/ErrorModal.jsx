...
import { RxCheck, RxCross2 } from "react-icons/rx"; // Ícone de sucesso

export default function ErrorModal({ titleError, textError }) {
    return (
        <motion.div
        ...
        >
            ...
            >
                ...
                {/* Ícone animado */}
                <motion.div
                    className="text-red-600 dark:text-red-400 my-8"
